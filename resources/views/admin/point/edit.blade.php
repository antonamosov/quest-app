            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        @include('admin.point._modal_answer_create')
                        @include('admin.point._modal_question_create')
                        @include('admin.point._modal_hint_create')

                        <ul class="nav navbar-right">
                            <li>
                                <button  data-toggle="modal" data-target="#myModal_question" class="btn btn-warning btn-xs">Add Question</button>
                            </li>
                        </ul>

                        <ul class="nav navbar-right">
                            <li>
                                <button   data-toggle="modal" data-target="#myModal_hint" class="btn btn-warning btn-xs">Add Hint</button>
                            </li>
                        </ul>

                        <ul class="nav navbar-right">
                            <li>
                                <button  data-toggle="modal" data-target="#myModal_answer" class="btn btn-warning btn-xs">Add Answer</button>
                            </li>
                        </ul>
                    ...
                    <div class="x_content">
                        ...
                        <form method="post" action="" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <!-- Route -->
                            <div class="form-group">
                                <label for="route_id" class="control-label col-md-3 col-sm-3 col-xs-12">Routes <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="route_id" name="route_id" class="form-control">

                                            @foreach($routes as $route)
                                                <option
                                                        @if($route->id == $point->route_id)
                                                                selected="selected"
                                                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_content">
                                        ...
                                        <div id="editor" class="editor-wrapper placeholderText" contenteditable="true">{{ $point->how_to_get }}</div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <img id="uploaded_image_id" src="{{ getenv('PUBLIC') }}{{ $point->Image->path }}">
                                </div>
                            </div>

                            <input type="hidden" name="uploaded_image_id" value="{{ $point->image_id }}">
