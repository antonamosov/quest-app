<!-- Modal -->
<div class="modal fade bs-example-modal-lg" id="myModal_question" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="/admin/point/{{ $point->id }}/question/create" class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="x_content">
                                    ...
                                    <div id="editor" class="editor-wrapper placeholderText" contenteditable="true">{{ old('paragraph') }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="x_content">
                                    ...
                                    <div id="editor2" class="editor-wrapper placeholderText" contenteditable="true">{{ old('question') }}</div>
