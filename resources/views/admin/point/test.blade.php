    ...
    <div class="">
        ...
        <div class="page-title">
            <div class="title_left">
                <h3><span style="color: red;"></span> Tour</h3>
            </div>
        </div>

        @if($manager->hasRole('global') || $manager->hasRole('admin'))
            <div style="float:right;">
                <a href="/admin/route/create"><button    class="btn btn-warning btn-xs">Create new Tour</button></a>
            </div>
        @endif
        ...
        @if($manager->hasRole('global') || $manager->hasRole('admin'))
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Edit Tour <small>Edit <span style="color: red;"></span> Tour</small></h2>
