<!-- Modal -->
<div class="modal fade bs-example-modal-lg" id="myModal_hint" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Create Hint</h4>
            </div>
            <div class="modal-body">

                <form method="post" action="/admin/point/{{ $point->id }}/hint/create" class="form-horizontal form-label-left" enctype="multipart/form-data">
