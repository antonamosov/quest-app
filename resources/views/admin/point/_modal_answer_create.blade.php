<!-- Modal -->
<div class="modal fade bs-example-modal-lg" id="myModal_answer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Create Answer</h4>
            </div>
            <div class="modal-body">

                <form method="post" action="/admin/point/{{ $point->id }}/answer/create" class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="x_content">
                                    ...
                                    <div id="editor" class="editor-wrapper placeholderText" contenteditable="true">{{ old('answer') }}</div>
