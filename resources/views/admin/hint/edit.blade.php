    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <a href="/admin/hint"><h3>Hints</h3><a>
            </div>
        </div>
                        ...
                        <form method="post" action="" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input value="{{ $hint->name }}" name="name" type="text" id="name" required="required" class="form-control col-md-7 col-xs-12" style="cursor: auto;">
                                </div>
                            </div>
                            ...
                            @if($manager->hasRole('global'))
                                <div class="form-group">
                                    <label for="admin_id" class="control-label col-md-3 col-sm-3 col-xs-12"> Owner of the hint <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select id="admin_id" name="admin_id" class="form-control">
                                            @foreach($admins as $admin)
                                                <option
                                                        @if($admin->id == $hint->user_id)
                                                                selected="selected"
                                                        @endif
                                ...
                                @endif
                                        ...
                                        <!-- Hint -->
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="hint"> Hint <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="x_content">
                                            <div id="alerts"></div>
                                            ...
                                            <div id="editor" class="editor-wrapper placeholderText" contenteditable="true">{{ $hint->hint }}</div>

                                            <textarea name="hint" id="descr" style="display:none;"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <script>
                                    function desc() {
                                        ...
                                        <!-- Oder -->
                                <div class="form-group">
                                    <label for="order" class="control-label col-md-3 col-sm-3 col-xs-12"> Order in the point <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <!-- Question -->
                                <div class="form-group">
                                    <label for="question_id" class="control-label col-md-3 col-sm-3 col-xs-12"> Question, associated with this hint <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select id="question_id" name="question_id" class="form-control">
                                            @foreach($questions as $question)
                                                <option
                                                        @if($question->id == $hint->question_id)
                                                                selected="selected"
                                                        @endif
