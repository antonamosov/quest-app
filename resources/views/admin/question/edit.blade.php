    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <a href="/admin/question"><h3>Questions</h3><a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Create Question <small></small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br>
                        <form method="post" action="" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input value="{{ $question->name }}" name="name" type="text" id="name" required="required" class="form-control col-md-7 col-xs-12" style="cursor: auto;">
                                </div>
                            </div>
                            ...
                            @if($manager->hasRole('global'))
                                <div class="form-group">
                                    <label for="admin_id" class="control-label col-md-3 col-sm-3 col-xs-12"> Owner of the question <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select id="admin_id" name="admin_id" class="form-control">
                                            @foreach($admins as $admin)
                                                <option
                                                        @if($admin->id == $question->user_id)
                                                                selected="selected"
                                                        @endif
                            ...
                            <!-- Paragraph -->
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="paragraph"> Paragraph <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_content">
                                        <div id="alerts"></div>
                                        ...
                                        <div id="editor" class="editor-wrapper placeholderText" contenteditable="true">{{ $question->paragraph }}</div>

                                        <textarea name="paragraph" id="descr" style="display:none;"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="x_content">
                                        ...
                                        <div id="editor2" class="editor-wrapper placeholderText" contenteditable="true">{{ $question->question }}</div>

                                        <textarea name="question" id="descr2" style="display:none;"></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <script>
                                    function desc() {
                                        var text1 = document.getElementById("editor");
                                        var text2 = document.getElementById("editor2");
                                        //console.log(": " + text.innerHTML);
                                        document.getElementById('descr').value = text1.innerHTML ;
                                        document.getElementById('descr2').value = text2.innerHTML ;
                                    }
                                </script>
